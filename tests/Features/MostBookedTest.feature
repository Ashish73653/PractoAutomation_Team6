Feature: Lab Test Booking and Payment
  @MostBookedTest
  Scenario Outline: User books lab tests successfully
    ...
    And user clicks on 1st item to add to cart in top booked test

    And user clicks on 5th item to add to cart in top booked test
    ...
    Examples:
      | URL                    | CartScreenshot | DateOfBirth | Gender | Email              | TimeSlot          | CardHolderName | CardNumber       | ExpiryMonth | CVV | ScreenshotName       |
      | https://www.practo.com | cart_page.png  | 25          | Male   | testuser@gmail.com | 06:00 AM-06:30 AM | Ashish Singh   | 4111111111111111 | 12/28       | 123 | lab_test_booking.png |